...
# a sprite is a 2D image or animation that you can move, rotate,
# and interact with in a game. Sprites are often used to represent game characters,
# objects, or anything that needs to be drawn on the screen.
...
class Alien(Sprite):
    ...
    def blitme(self):
        #Draw the alien at its current location."""#blit() is a method used to draw images, surfaces,
        # or sprites onto the screen or another surface
        # . The term "blit" is short for block image transfer
